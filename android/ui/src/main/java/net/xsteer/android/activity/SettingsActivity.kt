...
import net.xsteer.android.QuickTileService
import net.xsteer.android.R
import net.xsteer.android.preference.PreferencesPreferenceDataStore
import net.xsteer.android.util.AdminKnobs
...
class SettingsActivity : AppCompatActivity() {
    ...
    class SettingsFragment : PreferenceFragmentCompat() {
        ...
        override fun onCreatePreferences(savedInstanceState: Bundle?, key: String?) {
            ...
            // Настройки, которые в исходном проекте относились к модулю ядра и правам root:
            // одновременные туннели и восстановление при загрузке. Движок у нас один и модуля
            // ядра у протокола нет, поэтому их здесь нет вовсе — переключатель, которым нельзя
            // ничего переключить, хуже его отсутствия.
            arrayOf(
