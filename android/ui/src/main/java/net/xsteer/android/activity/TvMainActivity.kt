...
import net.xsteer.android.databinding.Keyed
import net.xsteer.android.databinding.ObservableKeyedArrayList
import net.xsteer.android.databinding.ObservableKeyedRecyclerViewAdapter
import net.xsteer.android.databinding.TvActivityBinding
import net.xsteer.android.databinding.TvFileListItemBinding
import net.xsteer.android.databinding.TvTunnelListItemBinding
import net.xsteer.android.model.ObservableTunnel
import net.xsteer.android.util.ErrorMessages
import net.xsteer.android.util.QuantityFormatter
...
class TvMainActivity : AppCompatActivity() {
    ...
    companion object {
        private const val TAG = "xsteer/TvMainActivity"
    }
}
