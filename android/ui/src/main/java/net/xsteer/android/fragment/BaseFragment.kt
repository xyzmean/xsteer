...
import net.xsteer.android.activity.BaseActivity
import net.xsteer.android.activity.BaseActivity.OnSelectedTunnelChangedListener
import net.xsteer.android.backend.GoBackend
import net.xsteer.android.backend.Tunnel
import net.xsteer.android.databinding.TunnelDetailFragmentBinding
...
abstract class BaseFragment : Fragment(), OnSelectedTunnelChangedListener {
    ...
    companion object {
        private const val TAG = "xsteer/BaseFragment"
    }
}
