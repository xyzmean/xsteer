...
import net.xsteer.android.databinding.LogViewerActivityBinding
import net.xsteer.android.util.DownloadsFileSaver
import net.xsteer.android.util.ErrorMessages
import net.xsteer.android.util.resolveAttribute
...
class LogViewerActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val TAG = "xsteer/LogViewerActivity"
    }
