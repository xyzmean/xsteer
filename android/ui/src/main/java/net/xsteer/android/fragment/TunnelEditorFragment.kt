...
import net.xsteer.android.databinding.TunnelEditorFragmentBinding
import net.xsteer.android.model.ObservableTunnel
import net.xsteer.android.util.AdminKnobs
import net.xsteer.android.util.BiometricAuthenticator
import net.xsteer.android.util.ErrorMessages
import net.xsteer.android.viewmodel.ConfigProxy
import net.xsteer.config.Config
import kotlinx.coroutines.launch

/**
 * Fragment for editing a настройка xsteer.
 */
class TunnelEditorFragment : BaseFragment(), MenuProvider {
    ...
    companion object {
        ...
        private const val TAG = "xsteer/TunnelEditorFragment"
    }
}
