...
import net.xsteer.android.backend.BackendException
import net.xsteer.config.BadConfigException
import net.xsteer.config.InetEndpoint
import net.xsteer.config.InetNetwork
import net.xsteer.config.ParseException
...
object ErrorMessages {
    ...
    private val BE_REASON_MAP = mapOf(
        ...
        BackendException.Reason.CONFIG_NOT_ACCEPTED to R.string.config_not_accepted_error
    )
