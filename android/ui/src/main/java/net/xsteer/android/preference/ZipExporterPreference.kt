 ...
 */
package net.xsteer.android.preference
...
import net.xsteer.android.util.DownloadsFileSaver
import net.xsteer.android.util.ErrorMessages
import net.xsteer.android.util.activity
import net.xsteer.android.util.lifecycleScope
...
class ZipExporterPreference(context: Context, attrs: AttributeSet?) : Preference(context, attrs) {
    ...
    companion object {
        private const val TAG = "xsteer/ZipExporterPreference"
    }
}
