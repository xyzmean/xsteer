...
public class Statistics {
     ...
     * @param rxBytes           The received traffic for the {@link net.xsteer.config.Peer} referenced by
     *                          the provided {@link Key}. This value is in bytes
     * @param txBytes           The transmitted traffic for the {@link net.xsteer.config.Peer} referenced by
     *                          the provided {@link Key}. This value is in bytes.
     * @param latestHandshake   The timestamp of the latest handshake for the {@link net.xsteer.config.Peer}
    ...
    /**
     * Get the statistics for the {@link net.xsteer.config.Peer} referenced by the provided {@link Key}
     *
     * @param peer A {@link Key} representing a {@link net.xsteer.config.Peer}.
