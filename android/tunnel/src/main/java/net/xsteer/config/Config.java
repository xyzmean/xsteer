...
public final class Config {
     ...
     * be parsed.
     *
     * @param stream a stream of UTF-8 text that is interpreted as a настройка xsteer
     ...
     * be parsed.
     *
     * @param reader a BufferedReader of UTF-8 text that is interpreted as a настройка xsteer
     * @return a {@code Config} instance representing the supplied configuration
     */
