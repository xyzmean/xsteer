...
пира, показать пиров, показать QR пира, убрать пира, состояние, снять хаб.
...
Ссылку хаб выпускает один раз и кладёт рядом с конфигурацией пира. Пропали оба файла — QR взять
неоткуда: **приватного ключа пира хаб не хранит**, и пира придётся выпустить заново.
